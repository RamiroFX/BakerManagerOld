...
public class V_inicio extends JFrame {
    ...
    //public v_jifMasterLogin Mlogin;
    ...
    public V_inicio() {
        ...
        try {
            ...
            //String imagePath =System.getProperty("user.dir")+"/recursos/Icono.png";
     ...
     * @return the login
     *
     * private v_jifMasterLogin getMLogin() { if(Mlogin==null){ Mlogin = new
     * v_jifMasterLogin(this); } return Mlogin;
    }
     */
    /**
